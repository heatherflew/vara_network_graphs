...
<center>
    <h2>Winlink Network Graph for VARA HF gatways + stations connected (5 days)</h2>


<iframe src="varahfconnected5_simple.php" style="border:none;" width=640px height=460px></iframe>
