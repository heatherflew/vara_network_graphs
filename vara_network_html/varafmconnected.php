...
<center>
    <h2>Winlink Network Graph for VARA FM gatways + stations connected</h2>


<iframe src="varafmconnected_simple.php" style="border:none;" width=640px height=460px></iframe>
