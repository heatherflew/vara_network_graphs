...
<html lang="en">
  <head>
    <title>Vara FM heard (today) - stations heard by gateways (5 days)</title>
...
<script src="logs/<?php echo $datestr; ?>_5_vhf_heard.js"> </script> 


    <script type="text/javascript">
      // create an array with nodes
      var nodes = new vis.DataSet(nodes_heard);


      // create an array with edges
      var edges = new vis.DataSet(edges_heard);
